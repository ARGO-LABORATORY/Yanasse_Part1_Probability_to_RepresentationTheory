...
\textbf{Efficiency}
  & $<$\$0.01 per ARC-AGI task suite (100s of tasks).  Runs in a browser, in JavaScript, on a CPU, on a phone, in airplane mode.  The NP-hard matching runs on commodity hardware---a MacBook Air's GPU discovered these 4 new proofs.
